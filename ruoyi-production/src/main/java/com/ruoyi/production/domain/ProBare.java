...
public class ProBare extends BaseEntity
{
    ...
    /** GP-台北 */
    @Excel(name = "GP-台北")
    private Float bareGp1;

    /** GP-白金 */
    @Excel(name = "GP-白金")
    private Float bareGp2;

    /** GP-专营 */
    @Excel(name = "GP-专营")
    private Float bareGp3;

    /** GP-特约 */
    @Excel(name = "GP-特约")
    private Float bareGp4;
    ...
    public void setBareGp1(Float bareGp1)
    {
        this.bareGp1 = bareGp1;
    }

    public Float getBareGp1()
    {
        return bareGp1;
    }
    public void setBareGp2(Float bareGp2)
    {
        this.bareGp2 = bareGp2;
    }

    public Float getBareGp2()
    {
        return bareGp2;
    }
    public void setBareGp3(Float bareGp3)
    {
        this.bareGp3 = bareGp3;
    }

    public Float getBareGp3()
    {
        return bareGp3;
    }
    public void setBareGp4(Float bareGp4)
    {
        this.bareGp4 = bareGp4;
    }

    public Float getBareGp4()
    {
        return bareGp4;
    }
